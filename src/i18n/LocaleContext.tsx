...
const copy: Record<Locale, Record<string, string>> = {
  en: {
    ...
    exportTitle: 'Render a synchronized MP4', exportNote: 'The selected render is produced locally and preserves the original decoded audio track.',
    outputResolution: 'Resolution', outputAspectRatio: 'Aspect ratio', outputEndCard: 'End card', currentOutput: 'Current output:',
    endCardAixel: 'AiXel end card', endCardArtist: 'Artist branding', endCardClean: 'No end card', independentArtist: 'Independent Artist',
    proTag: 'Pro', creatorProOnly: 'Included with Creator Pro', proExportBlocked: 'These output settings require Creator Pro. They are kept, but this export cannot run.',
    continuationTitle: 'Keep this project on this device?', continuationDisclosure: 'AiXel can temporarily save this project and source track on this device for up to 24 hours so it survives sign-in or secure checkout.',
    continuationPrivacy: 'The source track is not uploaded. The decoded audio buffer is never stored.', continuationContinue: 'Save temporarily and continue', continuationCancel: 'Cancel', continuationClear: 'Clear temporary copy',
    continuationRestored: 'Your prepared project and local source track were restored.', continuationSourceRequired: 'Your project settings were restored. Select the original source track again to continue.', dismiss: 'Dismiss',
    continuationAccountTitle: 'Continue this local project?', continuationAccountBody: 'This project was prepared before sign-in. Confirm before attaching it to', continuationAccountConfirm: 'Continue with this account', continuationAccountMismatch: 'This temporary project is bound to another account and was not attached.',
    authOpen: 'Open account', authLoading: 'Checking your account…', authSignedIn: 'Signed in', authAccount: 'Account', authSignIn: 'Sign in', authSignOut: 'Sign out', authOptional: 'An account is optional for the Free workflow.', authEmail: 'Email', authMagicLink: 'Email me a sign-in link', authMagicSent: 'Check your inbox for the secure sign-in link.', authGoogle: 'Continue with Google',
  ...
  fr: {
    ...
    exportTitle: 'Créer un MP4 synchronisé', exportNote: 'Le rendu sélectionné est produit localement et conserve la piste audio originale décodée.',
    outputResolution: 'Résolution', outputAspectRatio: 'Format d’image', outputEndCard: 'Générique', currentOutput: 'Sortie actuelle :',
    endCardAixel: 'Générique AiXel', endCardArtist: 'Identité artiste', endCardClean: 'Sans générique', independentArtist: 'Artiste indépendant',
    proTag: 'Pro', creatorProOnly: 'Inclus avec Creator Pro', proExportBlocked: 'Ces réglages de sortie nécessitent Creator Pro. Ils sont conservés, mais cet export ne peut pas démarrer.',
    continuationTitle: 'Conserver ce projet sur cet appareil ?', continuationDisclosure: 'AiXel peut enregistrer temporairement ce projet et sa piste source sur cet appareil pendant 24 heures afin qu’ils survivent à la connexion ou au paiement sécurisé.',
    continuationPrivacy: 'La piste source n’est jamais téléversée. Le tampon audio décodé n’est jamais stocké.', continuationContinue: 'Enregistrer temporairement et continuer', continuationCancel: 'Annuler', continuationClear: 'Effacer la copie temporaire',
    continuationRestored: 'Votre projet préparé et sa piste locale ont été restaurés.', continuationSourceRequired: 'Les réglages du projet ont été restaurés. Sélectionnez de nouveau la piste source originale pour continuer.', dismiss: 'Fermer',
    continuationAccountTitle: 'Continuer ce projet local ?', continuationAccountBody: 'Ce projet a été préparé avant la connexion. Confirmez avant de le rattacher à', continuationAccountConfirm: 'Continuer avec ce compte', continuationAccountMismatch: 'Ce projet temporaire est lié à un autre compte et n’a pas été rattaché.',
    authOpen: 'Ouvrir le compte', authLoading: 'Vérification du compte…', authSignedIn: 'Connecté', authAccount: 'Compte', authSignIn: 'Se connecter', authSignOut: 'Se déconnecter', authOptional: 'Un compte reste facultatif pour le parcours Free.', authEmail: 'E-mail', authMagicLink: 'Recevoir un lien de connexion', authMagicSent: 'Consultez votre boîte de réception pour le lien sécurisé.', authGoogle: 'Continuer avec Google',
