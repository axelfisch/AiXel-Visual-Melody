...
const copy: Record<Locale, Record<string, string>> = {
  en: {
    ...
    projectIdentity: 'Project Identity', trackTitle: 'Track title', artistName: 'Artist name', untitledTrack: 'Untitled track',
    trackTitlePlaceholder: 'Name your visual melody', artistNamePlaceholder: 'Artist or project name',
  ...
  fr: {
    ...
    projectIdentity: 'Identité du projet', trackTitle: 'Titre du morceau', artistName: "Nom de l’artiste", untitledTrack: 'Morceau sans titre',
    trackTitlePlaceholder: 'Nommez votre mélodie visuelle', artistNamePlaceholder: "Artiste ou nom du projet",
