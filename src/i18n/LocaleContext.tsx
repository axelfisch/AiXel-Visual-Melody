...
const copy: Record<Locale, Record<string, string>> = {
  en: {
    ...
    sixEngines: 'Six Visual Engines', sevenEngines: 'Six Visual Engines + One Special Prototype', enginesNote: 'Every world has its own language of light',
    ...
    cityCharacter: 'Architectural skyline of spectrum bars.', albumCharacter: 'Graphite vinyl and one gold accent.', neonCharacter: 'Synthwave light trails on deep purple.', orbCharacter: 'A luminous 3D sphere woven from living particles.',
    cosmicMood: 'The light breathes, nebulas drifting slowly like held breath.', geometryMood: 'Everything becomes geometric, circles moving in quiet harmony.', liquidMood: 'The interface turns liquid, ink folding into ink.', cityMood: 'A skyline of sound, architecture built from spectrum.', albumMood: 'Minimal and monochrome, the record spinning in silence.', neonMood: 'Lights turn to velvet, synthwave trails in the dark.', orbMood: 'A living constellation turns around the heart of the music.',
  ...
  fr: {
    ...
    sixEngines: 'Six moteurs visuels', sevenEngines: 'Six moteurs visuels + un prototype spécial', enginesNote: 'Chaque univers possède son propre langage de lumière',
