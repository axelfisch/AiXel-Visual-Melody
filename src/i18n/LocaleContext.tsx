...
const copy: Record<Locale, Record<string, string>> = {
  en: {
    ...
    endCardAixel: 'AiXel end card', endCardArtist: 'Artist branding', endCardClean: 'No end card',
  ...
  fr: {
    ...
    endCardAixel: 'Générique AiXel', endCardArtist: 'Identité artiste', endCardClean: 'Sans générique',
