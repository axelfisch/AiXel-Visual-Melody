...
export function validateLiquidColorsConfig(value: unknown): LiquidColorsConfig {
  ...
  return {
    ...
    glowIntensity: numberInRange(config.glowIntensity, liquidColorsDefaultConfig.glowIntensity, 0.5, 1.8),
    spaceScale: numberInRange(config.spaceScale, liquidColorsDefaultConfig.spaceScale, 0.8, 1.3),
    colorSaturation: numberInRange(config.colorSaturation, liquidColorsDefaultConfig.colorSaturation, 0.4, 1.6),
    sparkleDensity: numberInRange(config.sparkleDensity, liquidColorsDefaultConfig.sparkleDensity, 0, 1.6),
    warmth: numberInRange(config.warmth, liquidColorsDefaultConfig.warmth, -1, 1),
